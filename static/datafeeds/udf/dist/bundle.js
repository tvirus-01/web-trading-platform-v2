! function(e, s) {
    ...
    class t {
        ...
        getBars(e, t, r) {
            ...
            return void 0 !== r.countBack && (i.countback = r.countBack), void 0 !== e.currency_code && (i.currencyCode = e.currency_code), void 0 !== e.unit_id && (i.unitId = e.unit_id), new Promise((async(e, t) => {
                try {
        ...
        async _processTruncatedResponse(e, t) {
            let r = e.bars.length;
            try {
                for (; this._limitedServerResponse && this._limitedServerResponse.maxResponseLength > 0 && this._limitedServerResponse.maxResponseLength === r && t.from < t.to;) {
                    t.countback && (t.countback = t.countback - r), "earliestFirst" === this._limitedServerResponse.expectedOrder ? t.from = Math.round(e.bars[e.bars.length - 1].time / 1e3) : t.to = Math.round(e.bars[0].time / 1e3);
                    const s = await this._requester.sendRequest(this._datafeedUrl, "history", t),
                        i = this._processHistoryResponse(s);
                    r = i.bars.length, "earliestFirst" === this._limitedServerResponse.expectedOrder ? (i.bars[0].time === e.bars[e.bars.length - 1].time && i.bars.shift(), e.bars.push(...i.bars)) : (i.bars[i.bars.length - 1].time === e.bars[0].time && i.bars.pop(), e.bars.unshift(...i.bars))
                }
            } catch (e) {
                if (e instanceof Error || "string" == typeof e) {
                    const t = s(e);
        ...
        _processHistoryResponse(e) {
            ...
            if ("no_data" === e.s) t.noData = !0, t.nextTime = e.nextTime;
                ...
                for (let i = 0; i < e.t.length; ++i) {
                    ...
                    r && (o.open = parseFloat(e.o[i]), o.high = parseFloat(e.h[i]), o.low = parseFloat(e.l[i])), t && (o.volume = parseFloat(e.v[i])), s.push(o)
                }
            }
            return {
                bars: s,
    ...
    class i {
        ...
        _destroyTimers() {
            null !== this._timers && (clearInterval(this._timers.fastTimer), clearInterval(this._timers.generalTimer), this._timers = null)
        }
        _updateQuotes(e) {
            if (!(this._requestsPending > 0))
    ...
    class a {
        ...
        searchSymbols(e, s, t, r) {
            return this._readyPromise.then((() => {
                ...
                const n = i.sort(((e, s) => e.weight - s.weight)).slice(0, r).map((e => {
                ...
                for (; t < e; ++t) {
                    const e = s.symbol[t],
                        ...
                        _ = {
                            ...
                            supported_resolutions: l(o(s, "supported-resolutions", t, !0), this._datafeedSupportedResolutions),
                    ...
                    this._symbolsInfo[d] = _, this._symbolsInfo[e] = _, this._symbolsInfo[u] = _, void 0 === c && void 0 === h || (this._symbolsInfo[n(d, c, h)] = _, this._symbolsInfo[n(e, c, h)] = _, this._symbolsInfo[n(u, c, h)] = _), this._symbolsList.push(e)
                }
            } catch (r) {
    ...
    class c {
        ...
        resolveSymbol(e, t, r, i) {
            ...
            if (this._configuration.supports_group_request) {
                ...
                void 0 !== o && (t.currencyCode = o), void 0 !== n && (t.unitId = n), this._send("symbols", t).then((e => {
                    var s, t, i, o, n, l, u, c, h, d, _, m, p, b, y, g, f, v, P, q, w, S, x, R, k, I, U, B, D;
                    if (void 0 !== e.s) r("unknown_symbol");
                    else {
                        const r = e.name,
                            T = null !== (s = e.listed_exchange) && void 0 !== s ? s : e["exchange-listed"],
                            C = null !== (t = e.exchange) && void 0 !== t ? t : e["exchange-traded"],
                            L = null !== (i = e.full_name) && void 0 !== i ? i : `${C}:${r}`;
                        a({...e,
                            name: r,
                            base_name: [T + ":" + r],
                            full_name: L,
                            listed_exchange: T,
                            exchange: C,
                            currency_code: null !== (o = e.currency_code) && void 0 !== o ? o : e["currency-code"],
                            original_currency_code: null !== (n = e.original_currency_code) && void 0 !== n ? n : e["original-currency-code"],
                            unit_id: null !== (l = e.unit_id) && void 0 !== l ? l : e["unit-id"],
                            original_unit_id: null !== (u = e.original_unit_id) && void 0 !== u ? u : e["original-unit-id"],
                            unit_conversion_types: null !== (c = e.unit_conversion_types) && void 0 !== c ? c : e["unit-conversion-types"],
                            has_intraday: null !== (d = null !== (h = e.has_intraday) && void 0 !== h ? h : e["has-intraday"]) && void 0 !== d && d,
                            has_no_volume: null !== (_ = e.has_no_volume) && void 0 !== _ ? _ : e["has-no-volume"],
                            visible_plots_set: null !== (m = e.visible_plots_set) && void 0 !== m ? m : e["visible-plots-set"],
                            minmov: null !== (b = null !== (p = e.minmovement) && void 0 !== p ? p : e.minmov) && void 0 !== b ? b : 0,
                            minmove2: null !== (g = null !== (y = e.minmovement2) && void 0 !== y ? y : e.minmove2) && void 0 !== g ? g : e.minmov2,
                            session: null !== (f = e.session) && void 0 !== f ? f : e["session-regular"],
                            session_holidays: null !== (v = e.session_holidays) && void 0 !== v ? v : e["session-holidays"],
                            supported_resolutions: null !== (w = null !== (q = null !== (P = e.supported_resolutions) && void 0 !== P ? P : e["supported-resolutions"]) && void 0 !== q ? q : this._configuration.supported_resolutions) && void 0 !== w ? w : [],
                            has_daily: null === (x = null !== (S = e.has_daily) && void 0 !== S ? S : e["has-daily"]) || void 0 === x || x,
                            intraday_multipliers: null !== (k = null !== (R = e.intraday_multipliers) && void 0 !== R ? R : e["intraday-multipliers"]) && void 0 !== k ? k : ["1", "5", "15", "30", "60"],
                            has_weekly_and_monthly: null !== (I = e.has_weekly_and_monthly) && void 0 !== I ? I : e["has-weekly-and-monthly"],
                            has_empty_bars: null !== (U = e.has_empty_bars) && void 0 !== U ? U : e["has-empty-bars"],
                            volume_precision: null !== (B = e.volume_precision) && void 0 !== B ? B : e["volume-precision"],
                            format: null !== (D = e.format) && void 0 !== D ? D : "price"
                        })
                    }
                })).catch((e => {
